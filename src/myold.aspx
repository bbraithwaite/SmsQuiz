...
<script runat="server">
    ...
    If not isPostBack Then
      ...
      Dim userID As FormsIdentity
           ...
           lblCategory.Text = "Closed Competitions in the " & session("categorySel") & " category:"
           ...
           BindAll
           lblHeader.Text = "All"
           lblCategory.Text = "ALL Closed Competitions"
           ...
           response.redirect("user name error")
    ...
    sub BindDataGrid
                 ...
                 'get creator id to load relevant competitions
                  ...
                  strReader =  "SELECT [competition].* FROM [competition] WHERE (([competition].[creatorID] = @cr"& _
...
<html>
<head>
    <title>My Old Competitions</title>
